...
func Render(
	...
	// An ACP session carries a pay way only when the store offers a
	// collect-later method for its delivery (Handler.selectPayWay).
	out.Status = statusOf(s, s.PayWayID > 0)
